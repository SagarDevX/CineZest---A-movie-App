...
const Page = () => {
  ...
  return (
    ...
    <div>
      <div
        className="h-screen bg-cover bg-center relative transition-all duration-1000 bg-black"
      >

        <div
          className='w-full lg:w-3/5 h-full absolute right-0 center bg-cover bg-center bg-no-repeat'
          style={{
        ...
        <div className="relative flex flex-col justify-end lg:justify-center lg:items-center h-full  lg:w-1/2 py-20 select-none text-white">
          {currentMovie && (
            <div className=' lg:h-60 w-100 sm:w-120 flex flex-col ml-10 lg:ml-0  justify-center items-start'>
              <h1 className="text-5xl lg:text-6xl font-bold max-w-3xl text-start">{currentMovie.title}</h1>
              <p className="text-lg line-clamp-3 max-w-sm text-gray-400">
                {currentMovie.overview}
              </p>

            </div>
          )}
          <div className='flex flex-row gap-4 my-2 w-100 sm:w-120 ml-10 lg:ml-0 '>
