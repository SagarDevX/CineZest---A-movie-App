...
const Drama = () => {
    ...
    const DataFetch = async () => {
      try {
        ...
        const [page1, page2, page3] = await Promise.all([
          ...
          fetch(`${BASE_URL}?endpoint=discover/tv&with_genres=18&sort_by=popularity.desc&page=3`).then(r => r.json()),
        ])
  ...
  return (
    <div className="h-full max-w-8xl mx-auto mt-24  text-white flex-wrap items-center justify-center px-4 md:px-12">
      ...
      <p>Drama shows that explore the depth of human emotions, relationships, and the choices that shape our lives.</p>
        </div>
